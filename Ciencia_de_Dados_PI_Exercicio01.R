...
#Raiz cúbica
968^(1/3)
# Calcula o valor exponencial de 6 e divide pelo logaritimo de 156
exp(6)/log(156)

# 2 - Crie dois vetores. 1 vetor chamado nomes com os nomes das pessoas que moram na sua casa e 
# outro chamado idades com as idades de cada um deles.

nomes <- c("Layla", "Joaquina", "Maria Josefa")
idades <- c(24L, 35L, 56L)
nomes
idades
